export const symbolismHotspots = [
  {
    id: "head",
    label: "Head Position",
    x: 42,
    ...
    prompt: "Would this character lead by listening, or by commanding?",
  },
  {
    id: "eyes",
    label: "Eyes",
    ...
    prompt: "Notice how the eye shape changes your first impression.",
  },
  {
    id: "crown",
    label: "Crown",
    ...
    prompt: "Which details make this figure appear important?",
  },
  {
    id: "arms",
    label: "Arms",
    ...
    prompt: "Imagine the difference between a gentle bow and a sudden strike.",
  },
  {
    id: "body",
    label: "Body Shape",
    ...
    description:
      "Refined heroes are often represented with slender bodies, while powerful or impulsive figures may use broader, heavier silhouettes.",
    prompt: "What personality does this silhouette suggest before the character speaks?",
  },
  {
    id: "color",
    label: "Color & Detail",
    ...
    prompt: "Which color catches your eye first, and why?",
  },
];
